...
namespace MiniProject_TrainReservation
{
    ...
    public partial class MiniCaseStudyDBEntities1 : DbContext
    {
        public MiniCaseStudyDBEntities1()
            : base("name=MiniCaseStudyDBEntities1")
        {
        }
        ...
        public virtual int BookTicket(Nullable<int> trainId, string @class, string passengerName, Nullable<int> seatsBooked, Nullable<System.DateTime> bookingDate, Nullable<System.DateTime> departureDate)
        {
            var trainIdParameter = trainId.HasValue ?
                new ObjectParameter("trainId", trainId) :
                new ObjectParameter("trainId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BookTicket", trainIdParameter, classParameter, passengerNameParameter, seatsBookedParameter, bookingDateParameter, departureDateParameter);
        }
